...
void Controller::updateHead(Segment &newHead, Segment const &currentHead){
...
void Controller::checkPosition(Segment const newHead, bool &lost){
    if (not lost) {
...
void Controller::placeNewHead(Segment const newHead, bool &lost){
    if (not lost) {
...
void Controller::receive(std::unique_ptr<Event> e)
{
    try {
        *dynamic_cast<EventT<TimeoutInd> const&>(*e);
        ...
        Controller::checkPosition(newHead, lost);

        Controller::placeNewHead(newHead, lost);
